...
def init_db():
    ...
    # ── Seed parts ─────────────────────────────────────────
    # All images are verified automotive photos from Unsplash
    ...
    if parts_count == 0:
        parts = [
            ...
            (
                "Front Brake Pad Set",
                "Semi-metallic front brake pads for excellent stopping power and heat dissipation. OEM-spec fitment.",
                "Brakes", "Bosch", "BPF-4421", 48.99, 24,
                "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=900&q=85&auto=format&fit=crop",
                "Toyota Camry 2018-2023, Honda Accord 2017-2022"
            ),
            (
                "Rear Brake Pad Set",
                "Ceramic rear brake pads — low dust, quiet operation, great fade resistance.",
            ...
            (
                "Brake Rotor — Front Pair",
                "Slotted & cross-drilled rotors for improved heat dissipation. Fits most mid-size sedans.",
                "Brakes", "EBC", "RTR-2290", 124.99, 10,
                "https://images.unsplash.com/photo-1504222490345-c075b7b1abc0?w=900&q=85&auto=format&fit=crop",
                "Honda Civic 2016-2023, Toyota Corolla 2019-2023"
            ),
            (
                "Brake Caliper — Front Left",
                "Remanufactured front left caliper. Pressure tested. Direct bolt-on replacement.",
                "Brakes", "Cardone", "CLF-1830", 89.99, 8,
                "https://images.unsplash.com/photo-1596547609652-9cf5d8d76921?w=900&q=85&auto=format&fit=crop",
                "Chevrolet Malibu 2016-2022, Buick LaCrosse 2017-2019"
            ),
            # ── ELECTRICAL ─────────────────────────────────
            (
                "Car Battery 12V 600CCA",
                "Maintenance-free AGM battery. 600 cold cranking amps for reliable starts in any weather.",
            ...
            (
                "Alternator 160A",
                "High-output remanufactured alternator. 160A output. Includes new brushes and voltage regulator.",
                "Electrical", "Denso", "ALT-1602", 159.99, 7,
                "https://images.unsplash.com/photo-1612825173281-9a193378527e?w=900&q=85&auto=format&fit=crop",
                "Honda CR-V 2017-2022, Honda Pilot 2016-2022"
            ),
            (
                "Starter Motor",
                "OEM-equivalent starter motor. Pre-engaged, 1.4kW. No wiring modifications needed.",
                "Electrical", "Bosch", "STR-4410", 129.99, 9,
                "https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=900&q=85&auto=format&fit=crop",
                "Toyota Tacoma 2016-2023, Toyota 4Runner 2014-2023"
            ),
            (
                "MAF Sensor",
                "Mass Air Flow sensor. OEM-quality, pre-calibrated. Resolves P0100-P0104 fault codes.",
                "Electrical", "Delphi", "MAF-0821", 79.99, 15,
                "https://images.unsplash.com/photo-1486006920555-c77dcf18193c?w=900&q=85&auto=format&fit=crop",
                "Ford Mustang 2015-2023, Ford F-150 EcoBoost 2015-2023"
            ),
            (
                "O2 Sensor — Upstream",
                "Wideband upstream oxygen sensor. Improves fuel economy and resolves P0130-P0138 codes.",
                "Electrical", "Bosch", "O2U-3301", 44.99, 20,
                "https://images.unsplash.com/photo-1559416523-140ddc3d238c?w=900&q=85&auto=format&fit=crop",
                "Honda Civic 2012-2021, Honda CR-V 2012-2021"
            ),
            # ── ENGINE ─────────────────────────────────────
            (
                "Engine Oil Filter",
                "High-capacity spin-on oil filter. Anti-drain back valve. Fits most GM, Ford and Chrysler engines.",
                "Engine", "Fram", "OFE-3600", 9.99, 60,
                "https://images.unsplash.com/photo-1581235720704-06d3acfcb36f?w=900&q=85&auto=format&fit=crop",
                "GM V8 5.3L / 6.2L, Ford 5.0L Coyote, Dodge 5.7L Hemi"
            ),
            (
                "Spark Plug Set (4pcs)",
                "Iridium tip spark plugs. 100,000-mile service life. Improves fuel efficiency and cold starts.",
                "Engine", "NGK", "SPK-7090", 34.99, 30,
                "https://images.unsplash.com/photo-1562911791-c7a97b729ec5?w=900&q=85&auto=format&fit=crop",
                "Toyota Camry 2.5L 2018-2023, RAV4 2019-2023"
            ),
            (
                "Timing Belt Kit",
                "Complete timing belt kit: belt, tensioner, idler pulley and water pump. OEM-spec materials.",
                "Engine", "Gates", "TBK-2250", 149.99, 6,
                "https://images.unsplash.com/photo-1517524008697-84bbe3c3fd98?w=900&q=85&auto=format&fit=crop",
                "Honda Accord 2.4L 2008-2017, Honda CR-V 2.4L 2007-2016"
            ),
            (
                "Valve Cover Gasket",
                "Silicone valve cover gasket set. Stops oil leaks at cam cover. Includes all hardware.",
            ...
            (
                "Thermostat + Housing",
                "OEM thermostat (88°C) with housing and seal. Prevents overheating and heater problems.",
            ...
            (
                ...
                "Complete front strut assembly with spring and mount. No spring compression needed — bolt-on.",
                "Suspension", "Monroe", "STR-9021", 119.99, 8,
                "https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=900&q=85&auto=format&fit=crop",
                "Toyota Corolla 2009-2019, Matrix 2009-2014"
            ),
            (
                "Rear Shock Absorber Pair",
                "Gas-charged rear shocks. OEM ride quality. Comes as a pair for balanced handling.",
                "Suspension", "KYB", "SHK-3445", 94.99, 11,
                "https://images.unsplash.com/photo-1609152712027-76a5a7e8ce27?w=900&q=85&auto=format&fit=crop",
                "Honda Accord 2013-2017, Acura TLX 2015-2020"
            ),
            (
                "Control Arm — Front Lower",
                "Forged steel lower control arm with ball joint pre-installed. Corrects pull and tire wear.",
                "Suspension", "Moog", "CAL-8814", 109.99, 6,
                "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&q=85&auto=format&fit=crop&crop=center",
                "Ford Explorer 2011-2019, Edge 2011-2014"
            ),
            (
                "Wheel Hub & Bearing Assembly",
                "Pre-packed sealed hub bearing. Resolves wobble, grinding noise and ABS faults.",
                "Suspension", "Timken", "WHB-5530", 84.99, 13,
                "https://images.unsplash.com/photo-1504222490345-c075b7b1abc0?w=900&q=85&auto=format&fit=crop&crop=right",
                "GM Impala 2006-2016, Buick LaCrosse 2010-2016"
            ),
            # ── FILTERS ────────────────────────────────────
            (
                "Air Filter — Engine",
                "High-flow cotton gauze air filter. Washable & reusable. +5% airflow over OEM paper filter.",
                "Filters", "K&N", "AF-3399", 29.99, 35,
                "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=900&q=85&auto=format&fit=crop&crop=right",
                "Universal — multiple fitments available"
            ),
            (
                "Cabin Air Filter",
                "Activated carbon cabin filter. Blocks pollen, dust and odors. Easy under-dash replacement.",
                "Filters", "Bosch", "CAF-5571", 19.99, 45,
                "https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=900&q=85&auto=format&fit=crop&crop=right",
                "Toyota Camry 2012-2023, Avalon 2013-2022"
            ),
            (
                "Fuel Filter",
                "High-pressure inline fuel filter. 150-micron filtration. Protects injectors from debris.",
                "Filters", "Wix", "FF-2280", 24.99, 20,
                "https://images.unsplash.com/photo-1596547609652-9cf5d8d76921?w=900&q=85&auto=format&fit=crop&crop=right",
                "Honda Accord 2003-2012, Pilot 2003-2015"
            ),
            # ── COOLING ────────────────────────────────────
            (
                "Radiator",
                "OEM-spec aluminum core radiator. Full plastic tanks. Pressure tested to 20 PSI.",
                "Cooling", "Spectra", "RAD-1440", 189.99, 5,
                "https://images.unsplash.com/photo-1530046339160-ce3e530c7d2f?w=900&q=85&auto=format&fit=crop&crop=right",
                "Dodge Charger / Challenger 3.6L V6 2011-2023"
            ),
            (
                "Water Pump",
                "Cast iron impeller water pump. Includes gasket. Resolves overheating and coolant loss.",
                "Cooling", "Airtex", "WP-8814", 64.99, 14,
                "https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=900&q=85&auto=format&fit=crop&crop=right",
    ...
    if modules_count == 0:
        modules = [
            ("Automotive Electronics Fundamentals", "Fundamentos de Electrónica Automotriz",
             ...
             "Circuitos, sensores, actuadores y redes de comunicación del vehículo. Aprende a leer diagramas y rastrear fallas.",
            ...
            ("Hands-On Shop Learning Blocks", "Bloques de Aprendizaje en Taller Real",
             ...
             "Trabaja en vehículos reales junto a técnicos certificados. Herramientas reales, retroalimentación real.",
