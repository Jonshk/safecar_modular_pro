      ...
      <form onSubmit={save} className="adminForm">
        ...
        <div className="adminFormGrid">
          ...
          <label className="adminLabel" style={{gridColumn:"1/-1"}}>Image
            ...
            <span style={{fontSize:".72rem",color:"rgba(255,255,255,.2)",marginTop:4,display:"block"}}>
              Upload directly from your computer or paste any image URL.
            </span>
          </label>
    ...
    <div className="adminSection">
      ...
      <div style={{display:"flex",gap:10,marginBottom:16,flexWrap:"wrap",alignItems:"center"}}>
        ...
        <select className="ctInput" value={catFilter} onChange={e=>setCatFilter(e.target.value)}
          style={{minWidth:160,height:38,cursor:"pointer",background:"#111318",color:"#ffffff",borderColor:"rgba(255,255,255,.12)"}}>
